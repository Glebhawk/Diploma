...
namespace SpacecraftData.Migrations
{
    ...
    [Migration("20210504135103_CheckLaunchToSateliteBinding")]
    partial class CheckLaunchToSateliteBinding
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpacecraftData.Entities.Spacecraft", b =>
                {
                    ...
                    b.HasOne("SpacecraftData.Entities.Launch", null)
                        .WithMany("Payload")
            ...
            modelBuilder.Entity("SpacecraftData.Entities.Stage", b =>
                {
                    b.HasOne("SpacecraftData.Entities.Rocket", null)
                        .WithMany("Stages")
                        .HasForeignKey("RocketId");
                });
